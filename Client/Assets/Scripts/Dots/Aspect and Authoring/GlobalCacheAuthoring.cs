...
namespace Dots
{
    ...
    public class GlobalCacheAuthoring : MonoBehaviour
    {
        public class GlobalCacheAuthoringBaker : Baker<GlobalCacheAuthoring>
        {
            public override void Bake(GlobalCacheAuthoring authoring)
            {
                AddComponent<GlobalInitTag>();
            }
        }
    }
    
    public readonly partial struct GlobalCacheAspect : IAspect
    {
        public readonly Entity Entity;
        private readonly RefRO<MonsterMaterialsCache> _monsterMaterials;
