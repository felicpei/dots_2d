...
namespace Dots
{
    ...
    public partial struct MonsterInitialSystem : ISystem
    {
        public void OnCreate(ref SystemState state)
        {
            ...
            state.RequireForUpdate<CacheMonsterMaterials>();
        }
        ...
        {
            var globalCache = SystemAPI.GetSingletonEntity<CacheMonsterMaterials>();
            var globalAspect = SystemAPI.GetAspectRW<CacheAspect>(globalCache);
